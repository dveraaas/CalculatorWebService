...
- An example of "operation": Add(1+2+3+4), Subtract(1-2-3-4), Multiply(1*2*3*4). If you writes a bad expression in Add method such as 1*2*3*4, the server send you that there is a bad expression for Add method and you returns to the top again 
